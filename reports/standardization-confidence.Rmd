...
# 2. Display confidence intervals of a 100 samples (each of size 100), generated from a normally distributed population of 10,000

We are going to generate 100 samples from a normally distributed population of 10,000. We arbitrarily choose to set the mean to 20 and the standard deviation to 3. Given such a scenario, we expect on average 5% of the samples to not include the true value of the mean when we consider a 95% CI (5 samples out of 100), while 1% of the samples should not include the true mean when considering a 99% CI (1 sample out of 100).
```{r}
# Setting seed
set.seed(200)
...
# Second scenario (sample size = 30)
par(mfrow = c(1, 2))
plot_sample_ci(num_samples = 100, sample_size = 300, pop_size = 10000,
distr_func = runif)
title("Uniform distribution")
